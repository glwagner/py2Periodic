...
class doublyPeriodicModel(object):
    ...
    def _init_fft(self):
        ...
        if self.realVars:
            self.mklfft2  = mklfft.rfft2
            self.mklifft2 = mklfft.irfft2
            ...
            self.mklfft2  = (lambda x: mklfft.fft2(x))
            self.mklifft2 = (lambda x: mklfft.ifft2(x))
